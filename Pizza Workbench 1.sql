...
-- 2. Average Order Value :- The average amount spent per order, calculater by dividing the total revenue by the toal numebr of orders
-- 3. Total Pizzas Sold :- The sum of the quantitied of all pizzas sold
